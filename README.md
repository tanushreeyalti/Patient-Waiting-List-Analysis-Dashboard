...
Combined Inpatient and Outpatient data into a unified All_Data table

Cleaned and standardized fields (Specialty, Age Profile, Time Bands)
...
Average & Median Wait List (dynamic toggle)
...
Detailed Page: Hierarchical matrix for granular analysis
...
Toggle between Average/Median calculations
